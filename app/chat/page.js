...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    // logout intentionally omitted — it only touches refs and the router.
  ...
  // Paste an image to attach it to the composer. It is not sent immediately —
  // it becomes the pending attachment so a caption can be typed first.
  useEffect(() => {
    if (!joined) return;
    const onPaste = (e) => {
